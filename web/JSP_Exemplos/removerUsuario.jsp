...
<%     if ( null == request.getParameterValues("remover")){
%>
<h3 class="container-fluid">Página de remoção de usuários.</h3>
    <smal class="container-fluid">Página de remoção de usuários</smal>
<form action="./removerUsuario.jsp" method="post" class="form-horizontal container-fluid">
    <div class="row">
    ...
    <button type="submit" class="btn btn-success col-xs-4 col-xs-offset-3 col-md-2 col-md-offset-3" name="remover" id="remover" value="remover">remover</button>
    </div>
</form>
